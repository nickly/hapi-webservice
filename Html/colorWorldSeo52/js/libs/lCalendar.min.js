    ...
    return a.prototype = {
        ...
        bindEvent: function(a) {
            ...
            function c() {
                ...
                /^\d{4}-\d{1,2}-\d{1,2}$/.test(t.trigger.value) ? (rs = t.trigger.value.match(/(^|-)\d{1,4}/g), b.yy = rs[0] - t.minY, b.mm = rs[1].replace(/-/g, "") - 1, b.dd = rs[2].replace(/-/g, "") - 1) : b.yy = b.yy + 1900 - t.minY,
                    t.gearDate.querySelector(".date_yy").setAttribute("val", b.yy),
                    t.gearDate.querySelector(".date_mm").setAttribute("val", b.mm),
                    t.gearDate.querySelector(".date_dd").setAttribute("val", b.dd),
                    h()
            }
            function d(a) {
                t.gearDate = document.createElement("div"),
            ...
            function e() {
                ...
                /^\d{4}-\d{1,2}-\d{1,2}\s\d{2}:\d{2}$/.test(t.trigger.value) ? (rs = t.trigger.value.match(/(^|-|\s|:)\d{1,4}/g), b.yy = rs[0] - t.minY, b.mm = rs[1].replace(/-/g, "") - 1, b.dd = rs[2].replace(/-/g, "") - 1, b.hh = parseInt(rs[3].replace(/\s0?/g, "")), b.mi = parseInt(rs[4].replace(/:0?/g, ""))) : b.yy = b.yy + 1900 - t.minY,
                    t.gearDate.querySelector(".date_yy").setAttribute("val", b.yy),
                    t.gearDate.querySelector(".date_mm").setAttribute("val", b.mm),
                    t.gearDate.querySelector(".date_dd").setAttribute("val", b.dd),
                    h(),
                    t.gearDate.querySelector(".time_hh").setAttribute("val", b.hh),
                    t.gearDate.querySelector(".time_mm").setAttribute("val", b.mi),
                    i()
            }
            function f(a) {
                t.gearDate = document.createElement("div"),
            ...
            function g() {
                ...
                /^\d{2}:\d{2}$/.test(t.trigger.value) && (rs = t.trigger.value.match(/(^|:)\d{2}/g), b.hh = parseInt(rs[0].replace(/^0?/g, "")), b.mm = parseInt(rs[1].replace(/:0?/g, ""))),
                    t.gearDate.querySelector(".time_hh").setAttribute("val", b.hh),
            ...
            function h() {
                ...
                if (b && b.getAttribute("val")) {
                    ...
                    if (isNaN(f)) b.style["-webkit-transform"] = "translate3d(0," + (8 - 2 * d) + "em,0)",
                        b.setAttribute("top", 8 - 2 * d + "em");
                    else {
                        f % 2 == 0 ? f = f: f += 1,
                        f > 8 && (f = 8);
                        var g = 8 - 2 * (a - 1);
                        g > f && (f = g),
                            b.style["-webkit-transform"] = "translate3d(0," + f + "em,0)",
                            b.setAttribute("top", f + "em"),
                            d = Math.abs(f - 8) / 2,
                            b.setAttribute("val", d)
                    }
                    ...
                    if (h && h.getAttribute("val")) {
                        ...
                        h.innerHTML = c,
                            i > k ? (i = k, h.setAttribute("val", i)) : l > i && (i = k, h.setAttribute("val", i)),
                            h.style["-webkit-transform"] = "translate3d(0," + (8 - 2 * (i - l)) + "em,0)",
                            h.setAttribute("top", 8 - 2 * (i - l) + "em");
                        ...
                        if (m && m.getAttribute("val")) {
                            ...
                            var n = parseInt(m.getAttribute("val")),
                                ...
                                p = o - 1,
                                q = 0;
                            d == a - 1 && t.maxM == i + 1 && (p = t.maxD - 1),
                            0 == d && t.minM == i + 1 && (q = t.minD - 1);
                            for (var e = 0; p - q + 1 > e; e++) c += "<div class='tooth'>" + (q + e + 1) + "</div>";
                            m.innerHTML = c,
                                n > p ? (n = p, m.setAttribute("val", n)) : q > n && (n = q, m.setAttribute("val", n)),
                                m.style["-webkit-transform"] = "translate3d(0," + (8 - 2 * (n - q)) + "em,0)",
                                m.setAttribute("top", 8 - 2 * (n - q) + "em")
                        }
                    }
                }
            }
            function i() {
                ...
                if (a && a.getAttribute("val")) {
                    for (var b = "",
                             c = parseInt(a.getAttribute("val")), d = 0; 23 >= d; d++) b += "<div class='tooth'>" + d + "</div>";
                    a.innerHTML = b,
                    ...
                    if (e && e.getAttribute("val")) {
                        for (var b = "",
                                 f = parseInt(e.getAttribute("val")), d = 0; 59 >= d; d++) b += "<div class='tooth'>" + d + "</div>";
                        e.innerHTML = b,
            ...
            function l(a) {
                ...
                b["new_" + b.id] = a.targetTouches[0].screenY,
                ...
                b["pos_" + b.id] = b["o_d_" + b.id] + c,
                    ...
                    b.setAttribute("top", b["pos_" + b.id] + "em")
            }
            function m(a) {
                a.preventDefault();
                for (var b = a.target;;) {
                ...
                Math.abs(c) <= .2 ? b["spd_" + b.id] = 0 > c ? -.08 : .08 : Math.abs(c) <= .5 ? b["spd_" + b.id] = 0 > c ? -.16 : .16 : b["spd_" + b.id] = c / 2,
                            ...
                            switch (e > 8 && (e = 8, c = !0), a.dataset.datetype) {
                                ...
                                case "date_dd":
                                    var k = t.gearDate.querySelector(".date_yy"),
                                        ...
                                        s = r - 1,
                                        u = 0;
                                    l == d - 1 && t.maxM == q + 1 && (s = t.maxD - 1),
                                    0 == l && t.minM == q + 1 && (u = t.minD - 1);
                                    var h = 8 - 2 * (s - u);
                                    if (h > e && (e = h, c = !0), c) {
            ...
            function q(a) {
                ...
                e = e > 9 ? e: "0" + e,
                    t.trigger.value = c % b + t.minY + "-" + d + "-" + e,
                    p(a)
            }
            function r(a) {
                var b = t.maxY - t.minY + 1,
                ...
                g = g > 9 ? g: "0" + g,
                    t.trigger.value = c % b + t.minY + "-" + d + "-" + e + " " + (f.length < 2 ? "0": "") + f + (g.length < 2 ? ":0": ":") + g,
                    p(a)
            }
            function s(a) {
