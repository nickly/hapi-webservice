...
define(function(require, exports, module) {
	...
	var object = {};
    object.createDate=function(options){
    	function cPlugin(o){
    		var sjObj=o;
		        //默认参数
		        sjObj.defaults={
		            ...
		            df_box:function(){return $("</div><div class='df-box "+(sjObj.opt.alwaysShow?"alwaysShow":"")+"' style='line-height:"+sjObj.opt.height+"px;'></div>")},
		            ...
		            getArr:function(){
		                ...
		                for(var i=0;i<60;i++){
		                    ...
		                    if(i<60&&!options.mArr)this.mArr[i]=i;this.sArr[i]=i;
		                }
		            },
		            y:1,
		            nowTime:new Date(),
		            ...
		            buildHTml:function(){
		                ...
		                if(sjObj.opt.showNowTime){
		                	if(sjObj[0].value){
		                		...
		                		var str=sjObj[0].value;
		                		var reg=new RegExp('(.{10})','g');
		                		str=(sjObj.opt.Year?"":"2000-")+
		                		(sjObj.opt.Month?"":"01-")+
		                		(sjObj.opt.Day?"":"01")+
		                		str+
		                		(sjObj.opt.Hour?"":"01:")+
		                		(sjObj.opt.Minute?"":"01")+
		                		(sjObj.opt.Seconds?"":":01");
		                		console.log(str);
		                		str=str.replace(reg,'$1 ')
		                		console.log(str);
		                		console.log("字符串转时间");
		                		/*
		                		 * 此处需要自己根据长度判断 上面为显示 小时分。 显示不同的
		                		 * 
		                		 */
		            ...
		            moveElm:function(eml){
		                ...
		                return $(eml).each(function(){
		                    ...
		                    var sX=null,sY=null,
		                        mX=null,mY=null,
		                        eX=null,eY=null,
		                        sTime=null,eTime=null,mTime=null,nTime=null,//开始时间，结束时间，移动时的时间，开始到现在花费的时间
		                        nY=0,drt=null,nowElm=null,//现在的Y位置。方向，当前元素
		                        canStart=true,canMove=false,canEnd=false,//移动事件条件。。
		                        emlLang=null,//子元素长度
		                        maxY=null,minY=null,//最大距离和最小距离
		                        lastY=null,nowY=null,moveY=null,
		                        stopInertiaMove=false,//是否停止惯性滚
		                        SE=null,ME=null,EE=null,moveCy=0;
		                    var stop=function(e){
		                        //Opera/Chrome/FF
		                        if (e.preventDefault)
		                            e.preventDefault();
